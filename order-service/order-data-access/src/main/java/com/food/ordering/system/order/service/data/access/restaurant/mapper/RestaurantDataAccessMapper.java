...
import com.food.ordering.system.data.access.resturant.entity.RestaurantEntity;
import com.food.ordering.system.data.access.resturant.exception.RestaurantDataAccessException;
...
public class RestaurantDataAccessMapper {
    ...
    public Restaurant restaurantEntityToRestaurant(List<RestaurantEntity> restaurantEntities) {
        ...
        return Restaurant.builder()
                .restaurantId(new RestaurantId(restaurantEntity.getProductId()))
