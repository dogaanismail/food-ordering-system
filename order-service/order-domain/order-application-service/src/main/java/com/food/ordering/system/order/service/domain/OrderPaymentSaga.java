...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        if (orderPaymentOutboxMessageResponse.isEmpty()) {
            log.info("An outbox message with sage id: {} is already roll backed!", paymentResponse.getSagaId());
            return;
        }
    ...
    private OrderPaidEvent completePaymentForOrder(PaymentResponse paymentResponse) {
        log.info("Completing payment with order id:{}", paymentResponse.getOrderId());
    ...
    private Order rollbackPaymentForOrder(PaymentResponse paymentResponse) {
        log.info("Cancelling order with id: {}", paymentResponse);
        Order order = orderSagaHelper.findOrder(paymentResponse.getOrderId());
